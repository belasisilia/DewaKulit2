        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-5 d-flex justify-content-between">
          <li class="nav-item mx-5">
            <a class="nav-link active" aria-current="page" style="white-space: nowrap;"
              href="<?php echo e(url('new-arrival')); ?>">NEW ARRIVAL</a>
          </li>
          <li class="nav-item mx-5">
            <a class="nav-link" href="<?php echo e(url('products')); ?>">PPRODUCTS</a>
          </li>
          <li class="nav-item mx-5">
            <a class="nav-link" href="<?php echo e(url('sale')); ?>">SALE!</a>
          </li>
        </ul>
...
</section><?php /**PATH C:\xampp\php\Dewa-Kulit-Laravel-main\resources\views/layouts/navbar.blade.php ENDPATH**/ ?>